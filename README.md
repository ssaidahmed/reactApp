Сделал это тестовое задание: <br/>
...
Доп задание: Также создать вторую таблицу, в которой будут хранится работники (ФИО, должность, зп). Эти работники выбираются в первой таблице в поля “Ответственный за тур”. <br/>
Код в коммитах "add table editor CRUD operation"